...
const fallback = {
  ...
  mission:
    "To provide free, quality education and learning resources to underprivileged children across India.",
  vision:
    "A world where every child has the opportunity to learn, grow, and reach their full potential.",
  ...
  registration_details:
    "Registered under Societies Registration Act, 1860 | Reg No: MP/EDU/2014/00123 | 80G & 12A Certified",
...
export const ContentProvider = ({ children }) => {
  ...
  const refresh = async () => {
    try {
      ...
      // Backend unavailable — fallback content already set, continue silently
    } finally {
      setLoaded(true);
    }
  };
...
// export const useContent = () => useContext(ContentContext);
// Separate file se export karna chahiye tha, lekin React Fast Refresh ke liye
// hooks aur components ek hi file mein nahi chahiye — isliye workaround:
function useContent() {
