...
export default function Contact() {
  ...
  const hours    = content.contact_hours    || "Mon â€“ Sat: 9:00 AM â€“ 6:00 PM";
  ...
  const mapLabel = content.contact_map_label || "ðŸ“ Khandwa, Madhya Pradesh";
        ...
        <div className="lg:col-span-2">
          <form onSubmit={handleSubmit} className="bg-chalk border border-white/10 rounded-card p-6 md:p-8 space-y-5 shadow-sm">
            ...
            <button type="submit" disabled={loading || submitted}
              ...
              {submitted ? <>âœ… Message Sent!</> : loading ? "Sending..." : <><FiSend /> Send Message</>}
            </button>
          </form>
        </div>
      </section>
